...
const EditQuiz = () => {
  ...
  const onErrorQuizCoverImageUrl = "https://media.discordapp.net/attachments/1115338683671908462/1119589308291096586/image.png"
            ...
            <div className="edit__quiz__detail__container">
              <div className="cover__image__container">
                <div className="image__cover">
                  <img src={ quizCoverImage ? quizCoverImage : onErrorQuizCoverImageUrl}></img>
                </div>
