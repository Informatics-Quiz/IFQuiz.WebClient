                ...
                <div className='section-1'>
                    ...
                    <div className='text-2'>
                        <div className='col-sm-12 col-md-6 col-xl-4'>
                            ...
                            >
                                <img src={Google} alt='Email logo' width={'22.5px'} height={'22.5px'} style={{ margin: '4px', marginRight: '10px' }}></img>Signup with Google
                            </Link>
                        </div>
                        <div className='col-sm-12 col-md-6 col-xl-4 mt-2'>
                            <Link
                                ...
                                style={{ textDecoration: 'none', color: 'white', backgroundColor: '#238636', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '3px' }}
                            >
                                <img src={Email} alt='Email logo' width={'25px'} height={'25px'} style={{ margin: '4px', marginRight: '10px' }}></img>Signup with Email
                            </Link>
                        </div>
                    </div>
